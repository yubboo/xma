 ...
 * 关联模块：apps/desktop/scripts/electron/runtime.ts、install-runtime.ts。
...
import { installElectronRuntimeArchive, resolveElectronCacheRoot, type ElectronArchiveExtractor } from '../scripts/electron/runtime.ts'
