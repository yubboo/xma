...
| Windows / Unix JavaScript Runtime 更新 | `scripts/runtime/update.mjs` 是 Bun/OpenTUI/Solid + Workspace install/rebuild 的唯一事务入口；Windows `xma-prepare.ps1`、Unix console、CI、Release 只委托它，不重复拼 pnpm 阶段 |
