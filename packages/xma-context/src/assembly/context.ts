 ...
 * 关联模块：xma-agent-loop、xma-session、Workspace/Skill/Knowledge/Plugin Context Source。
...
import type { WorkspaceAccessDecision, WorkspaceAccessRequest, WorkspaceBinding } from '../workspace/workspace.ts'

export interface ContextAssemblyRequest {
  header: { sessionId: string; agentId: string; workspace?: WorkspaceBinding }
  snapshot: { header: { sessionId: string; agentId: string }; events: readonly unknown[] }
  turnId: string
  stepId: string
  signal: AbortSignal
