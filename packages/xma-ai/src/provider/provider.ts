 ...
 * 关联模块：model.ts、runtime.ts、plugins/deepseek/*、未来 Settings/App Protocol。
...
import type { ModelProvider } from '../model/model.ts'
import type { JsonObject } from '../protocol/json.ts'
