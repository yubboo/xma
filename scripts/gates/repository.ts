...
const requiredIgnoreRules = [
  'node_modules/', '.pnpm-store/', 'dist/', 'build/', 'coverage/', '/runtime/', 'xma-path/', '.xma/', '.xma-package/', 'workspaces/',
...
const forbidden = (path: string): boolean => {
  ...
  const dirs = ['node_modules/', '.pnpm-store/', '.cache/', '.turbo/', 'dist/', 'build/', 'coverage/', 'xma-path/', '.xma/', '.xma-package/', 'workspaces/', 'target/', 'native/target/', 'apps/desktop/release/', 'apps/desktop/web/', 'apps/desktop/native/']
