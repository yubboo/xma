...
for (const marker of ['https://github.com/yubboo/xma.git', '0.1.100', 'XMA-Sync.bat', 'DeepSeek Harness', 'Electron 41.2.0', 'Tauri 2', 'AGENT-RUNTIME.md', 'MODEL-PROVIDER.md', 'UPSTREAM-REFERENCE.md', '.codex/', '.claude/']) {
